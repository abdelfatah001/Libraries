...
public:
    ...
    static void  Srand()
    {
        //Seeds the random number generator in C++, called only once at main
    ...
    static string NumberToText (int num)
    {
        ...
        if (num >=20 && num <= 99)
        {
            string arr [] = {"","","Twenty","Thirty","Foyrty","Fifty","Sixty","Seventy","Eighty","Ninty"};
        ...
        {
            return "One Thausand " + NumberToText(num%1000);
        }
        if (num >=2000 && num <= 999999)
        {
            return NumberToText(num/1000) + "Thausand " + NumberToText(num%1000);
        }
